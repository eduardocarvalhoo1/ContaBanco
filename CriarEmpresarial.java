...
public class CriarEmpresarial extends javax.swing.JFrame {
    
    private ContaEmpresarial conta;
    private BDEmpresarial gerConta = new BDEmpresarial();
    private static CriarEmpresarial ccUnic;
   
    
    private CriarEmpresarial() {
        initComponents();
    }
    //MÉTODO SINGLETON
    public static CriarEmpresarial getCriarEmpresarial(){
        if(ccUnic == null){
            ccUnic = new CriarEmpresarial();
        }
        return ccUnic;
    }
    ...
    private void initComponents() {
        ...
        lblEmp.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblEmp.setText("Valor do emprestimo:");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblEmp)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ctEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    public void listar(){
        ...
        for(Conta c : gerConta.getBd()){
            modelo.insertRow(linha, new Object [] {c.getNumero(), c.getTitular(), c.getSaldo()});
            linha++;
        }
    }
    ...
    public void cadastrarConta(){
        ...
        try{
            ...
            conta.saque(saque);
            double emprestimo = Double.parseDouble(ctEmp.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CriarEmpresarial().setVisible(true);
            }
        });
    }
