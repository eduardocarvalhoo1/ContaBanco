...
public class CriarEstudantil extends javax.swing.JFrame {
    
    private ContaEstudantil conta;
    private BDEstudantil gerConta = new BDEstudantil();
    private static CriarEstudantil ccUnic;
   
    
    private CriarEstudantil() {
        initComponents();
    }
    //MÉTODO SINGLETON
    public static CriarEstudantil getCriarEstudantil(){
        if(ccUnic == null){
            ccUnic = new CriarEstudantil();
        }
        return ccUnic;
    }
    ...
    private void initComponents() {
        ...
        lblLimtEmp = new javax.swing.JLabel();
        ctLimtEmp = new javax.swing.JTextField();
        ...
        tblConta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número da Conta", "Titular", "Saldo", "Instituição", "Limite de emprestimo"
            }
        ));
        ...
        lblLimtEmp.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblLimtEmp.setText("Aumento do emprestimo:");

        lblInstituicao.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(CtDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblLimtEmp)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ctLimtEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblInstituicao)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ctInstituicao, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblInstituicao)
                    .addComponent(ctInstituicao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ctLimtEmp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblLimtEmp))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btCadastrar)
    ...
    public void listar(){
        ...
        for(ContaEstudantil c : gerConta.getBd()){
            modelo.insertRow(linha, new Object [] {c.getNumero(), c.getTitular(), c.getSaldo(), c.getInstuicao(), c.getLimiteEmprestimoEstudantil()});
            linha++;
        }
    }
    ...
    public void cadastrarConta(){
        ...
        try{
            ...
            conta.saque(saque);
            conta.setInstuicao(ctInstituicao.getText());
            double aumento = Double.parseDouble(ctLimtEmp.getText());
            conta.aumentarLimite(aumento);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CriarEstudantil().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField ctLimtEmp;
    ...
    private javax.swing.JLabel lblLimtEmp;
